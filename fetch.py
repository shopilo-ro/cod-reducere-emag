#!/usr/bin/env python3
"""
Fetch coduri de reducere eMAG de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/emag.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/emag.ro"
STORE_NAME = "eMAG"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru eMAG de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-emag)"
    }
    try:
