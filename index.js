#!/usr/bin/env node
/**
 * Fetch coduri reducere eMAG de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/emag.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/emag.ro";
const STORE_NAME  = "eMAG";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-emag)" }
  });
